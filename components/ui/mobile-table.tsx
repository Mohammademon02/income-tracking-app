      ...
      renderItem={(acc) => (
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-foreground truncate">{acc.name}</h3>
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="bg-primary/10 rounded-lg p-3">
              ...
              <div className="text-primary text-xs">Available Balance</div>
            </div>
          ...
          {acc.pendingWithdrawals > 0 && (
            <Badge className="bg-warning-muted text-warning border-warning/30">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-foreground">{ent.accountName}</h3>
                <p className="text-sm text-muted-foreground">
