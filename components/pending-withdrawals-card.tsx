        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute top-2 left-0 w-full h-1 bg-gradient-to-r from-transparent via-orange-400/30 to-transparent"></div>
                    <div className="absolute top-6 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-orange-300/20 to-transparent"></div>
                    <div className="absolute top-12 right-8 w-1.5 h-1.5 bg-orange-500/40 rounded-full"></div>
                    <div className="absolute top-16 right-16 w-1 h-1 bg-orange-400/30 rounded-full" style={{ animationDelay: '0.7s' }}></div>
                </div>
                <div className="absolute top-0 right-0 w-20 h-20 bg-orange-200/30 rounded-full -mr-10 -mt-10 transition-all duration-500 hover:bg-orange-300/40" style={{ animationDelay: '0.8s' }}></div>

                <CardHeader className="flex flex-row items-center justify-between pb-2 relative z-10">
                    <CardTitle className="text-sm font-semibold text-orange-800/90">Pending Withdrawals</CardTitle>
                    <Clock className="h-5 w-5 text-orange-600" style={{ animationDelay: '0.3s' }} />
                </CardHeader>
                <CardContent className="relative z-10">
                    ...
                    <div className="flex items-center justify-between mt-2 text-orange-800/80">
                        <div className="flex items-center">
                            <ArrowUpRight className="w-4 h-4 mr-1 text-orange-600" style={{ animationDelay: '0.5s' }} />
